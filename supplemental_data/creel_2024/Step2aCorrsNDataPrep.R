...
library(readr)
library(here)
read_path <- here("supplemental_data","creel_2024")
...
##################################
if (readthisone=="n"){
  dat=read.csv(here(read_path,'allnovels.csv')) ## allnovels is generated by a long ugly script that is omitted in shared version.
} else if (readthisone=="f"){
  dat=read.csv(here(read_path,'allfamiliars.csv')) ## allfamiliars is similarly generated by a long ugly script that is omitted in shared version. 
} else if (readthisone=="w"){
  dat=read.csv(here(read_path,'allnovels.csv'));dat2=read.csv(here(read_path,'allfamiliars.csv'));
