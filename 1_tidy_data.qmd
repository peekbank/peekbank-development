...
Finally, it will make life easier for now if we filter kids >= 12months. We can revisit this. (Note: in new data version this was moved into initial data filter)
