...
# Checks on data distributional assumptions 
...
```{r rt-hist, fig.cap="\\label{fig:rt-hist} Distribution of RT overlaid with log normal distribution, split by age.", fig.pos="h!", fig.width=8, fig.height=5}
