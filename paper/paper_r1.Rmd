...
clean_names <- tribble(
  ...
  "sander-montant_2022", "Sander-Montant et al. (2023)", 
...
"kremin_2021", "Kremin et al. (2023)",
"moore_bergelson_2022_verb", "Moore & Bergelson (2022)",
"byers-heinlein_2017", "Byers-Heinlein et al. (2017)"
)
dataset_characteristics |> left_join(clean_names) |> left_join(dataset_pcts) |> arrange(desc(pct_trials)) |> 
  ...
  kable_styling(latex_options="scale_down") |> row_spec(30, hline_after=T)
```
