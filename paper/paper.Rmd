...
Yet individual experiments measuring processing with young children typically recruit relatively small samples in a restricted range of ages. These samples provide neither the range of ages nor the number of participants to estimate the broader dynamics of how word recognition changes developmentally and how it connects with broader changes across the lifespan [@mcmurray2022slow;@colby2023efficiency]. One influential recent hypothesis refers to language learning as a process of learning the skill of real-time processing  [@christiansen2016;@chater2018]. On this hypothesis, we should expect to see many of the signatures of expertise and skill learning in language processing: speed of processing should decrease asymptotically with age [@kail1991;@anderson1982] and trial-to-trial variability should decrease [@todorov2002optimal]. Further, previous findings have provided limited and sometimes conflicting evidence on the relation between word recognition and language learning [@Weisleder2013;@peter2019;@newbury2016interrelationships]. To the extent that there are consistent relations between vocabulary and word recognition, these should be visible in a larger dataset. 
