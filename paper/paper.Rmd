...
We used a new database aggregating results across many individual developmental eye-tracking experiments to investigate the developmental course of word recognition and its relationship with early language learning. We found continuous developmental changes across all measures, consistent with a characterization of word recognition as a skill. Speed and accuracy both improved asymptoticaly, with evidence that recognition speed showed the log-log relationship associated with the power law of practice, that is, gradually converging on mature levels of processing efficiency. Further, older children showed less variability in accuracy and reaction time across trials, indicating more robust execution of this skilled behavior.
