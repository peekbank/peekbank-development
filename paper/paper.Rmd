...
edges <- get_edges(fit3_age) |> filter(label!="1.00") |> mutate(label_location=.5)
...
node_text <- tribble(~name, ~ pretty,
                     "acc_t0", "t0 Accuracy",
                     "acc_t1", "t1 Accuracy",
                     "acc_t2", "t2 Accuracy",
                     "acc_t3", "t3 Accuracy",
                     "acc_t4", "t4 Accuracy",
                     "accuracy_intercept", "Accuracy intercept",
                     "accuracy_slope", "Accuracy slope",
                     "log_rt_t0", "t0 log RT",
                     "log_rt_t1", "t1 log RT",
                     "log_rt_t2", "t2 log RT",
                     "log_rt_t3", "t3 log RT",
                     "log_rt_t4", "t4 log RT",
                     "prod_t0" , "t0 Production",
                     "prod_t1" , "t1 Production",
                     "prod_t2" , "t2 Production" ,
                     "prod_t3", "t3 Production",         
                     "prod_t4", "t4 Production" ,
                     "speed_intercept" , "Speed intercept" ,  
                     "speed_slope" , "Speed slope",
                     "vocab_intercept", "Vocabulary intercept",
                     "vocab_slope", "Vocabulary slope" )
...
edges[58,"color"]="green"
edges[60,"curvature"]=82
edges[60,"color"]="green"
edges[65,"curvature"]=80
edges[65,"color"]="green"
