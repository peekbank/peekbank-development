...
nodes <- get_nodes(fit3_age)

edges <- get_edges(fit3_age) |> filter(label!="1.00") |> 

graph_sem(edges=edges, nodes=nodes, text_size = 2, layout = t(layout_age),
          rect_width=2,
          rect_height=1.2,
          ellipses_width=1.5,
          ellipses_height=1.5,
...
graph_sem(model = slopes_long, text_size = 2)
