...
node_text <- tribble(~name, ~ pretty, ~fill, 
                     "acc_t0", "t0 Accuracy", "lightblue",
                     "acc_t1", "t1 Accuracy", "lightblue",
                     "acc_t2", "t2 Accuracy","lightblue",
                     "acc_t3", "t3 Accuracy","lightblue",
                     "acc_t4", "t4 Accuracy","lightblue",
                     "accuracy_intercept", "Accuracy intercept","lightblue",
                     "accuracy_slope", "Accuracy slope","lightblue",
                     "log_rt_t0", "t0 log RT","pink",
                     "log_rt_t1", "t1 log RT","pink",
                     "log_rt_t2", "t2 log RT","pink",
                     "log_rt_t3", "t3 log RT","pink",
                     "log_rt_t4", "t4 log RT","pink",
                     "prod_t0" , "t0 Production", "lightgreen",
                     "prod_t1" , "t1 Production",  "lightgreen",
                     "prod_t2" , "t2 Production" ,  "lightgreen",
                     "prod_t3", "t3 Production",          "lightgreen",
                     "prod_t4", "t4 Production" , "lightgreen",
                     "speed_intercept" , "Speed intercept" ,  "pink",
                     "speed_slope" , "Speed slope","pink",
                     "vocab_intercept", "Vocabulary intercept", "lightgreen",
                     "vocab_slope", "Vocabulary slope",  "lightgreen" ) |> 
  mutate(alpha=.5)
...
edges <- get_edges(slopes_long) |> mutate(label_location=.5) |> mutate(label=ifelse(arrow=="last", NA, label)) |>  mutate(connect_from=ifelse(to==from, "right",NA),
  ...
  mutate(color="black", label_hjust=.5, label_location=.5)
...
edges[58,"color"]="darkgreen"
edges[60,"curvature"]=82
edges[60,"color"]="darkgreen"
edges[60,"label_location"]=.45
edges[65,"curvature"]=80
edges[65,"color"]="darkgreen"
